...
const socialMediaLinks = {
  github: 'https://github.com/DylanNAron',
  ...
  projects: [
    {
      ...
      projectDesc:
        'Developed a custom data driven game engine in C++. Implemented multiple design patterns to allow for deserialization and instantiation of objects written in Json.',
      footerLink: [
        {
          name: 'View Repo',
    ...
    },
    {
      ...
      projectDesc:
        'Multiplayer VR Ride experience based off the Harry Potter TriWizard Cup. Lead the development for networking and proper replication of game play mechanics',
      footerLink: [
        {
          name: 'View Gameplay',
    ...
    {
      image: require('./assets/images/SkateboardMocap.png'),
      projectName: 'Skateboard Controller Programming Project',
      projectDesc:
        "Created a controller in Unreal Engine, inspired by EA's Skate. developed realistic movement, follow camera, flipping, spinning, grinding, and analog flick gesture recognition. The project also features motion capture animations that I performed skating myself!",
      footerLink: [
        {
          name: 'Read Blogs',
          url: 'https://medium.com/@arondylan72/list/skateboard-controller-programming-project-96243e75d40c',
        },
        {
          name: 'View Repo',
...
const achievementSection = {
  title: 'Games',
  subtitle: 'Check out some of my published games!',
